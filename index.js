...
const express = require("express"); // CommonJS as opposed to import React from 'react' -> ES6 Modules
const pg = require("pg");
const cors = require("cors");

const Client = pg.Client; // instead of const { Client } = require("pg");
...
function createClient() {
    const client = new Client({
        connectionString: process.env.example.DATABASE_URL,
        ssl: {
